...
<body>
    <form id="form1" runat="server">
         <div class ="login_form">
            ...
            <input type="password" runat="server" id="TxtPassword" class="input" title="Digite sua Senha aqui." /> 
             <label class="Label_login" id  ="LblConfirmPassword" title="Confirmar Senha">Confirmar Senha</label>           
            <input type="password" runat="server" id="TxtConfirmPassword" class="input" title="Confimrme sua Senha aqui."/> 
